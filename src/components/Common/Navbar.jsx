  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        ...
        // Defensive: ensure we always store an array (fallback to empty array)
      ...
      {!hideNavbar && (
        ...
        >
          <div className="flex w-full max-w-screen-lg items-center justify-between px-4 md:px-6">
            {/* Logo */}
            <Link to="/">
              <img className="left-8" src={logo} alt="Logo" width={160} height={32} loading="lazy" />
            </Link>
            {/* Navigation links */}
            <nav className="hidden md:flex">
              <ul className="flex gap-x-6 text-richblack-25">
                {Array.isArray(NavbarLinks) && NavbarLinks.map((link, index) => (
                      ...
                      >
                        ...
                        >
                          ...
                          {loading ? (
                            ...
                            Array.isArray(subLinks) && subLinks.map((subLink, i) => (
